          ...
          {!deleted && (
            <div className="danger-message">
              <div>
                ...
                <p>
                  Are you sure you want to remove publisher {title} from the
                  library?
                </p>
              </div>
              <div>
                <button onClick={handleDelete}>Yes</button>
                <Link to={`/publishers/${id}`} className="btn-link">
                  No
                </Link>
              </div>
            </div>
          ...
          {deleted && (
            <div className="success-message">
              <div>
                ...
                <p>
                  You have successfully deleted publisher {title} from the
                  library.
                </p>
              </div>
